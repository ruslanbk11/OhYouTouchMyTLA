...
thread2Enter: while TRUE do
    MonitorEnter2:
        ...
        mutex := "thread2";
    Enque: queue := queue + 1;
    MonitorPulseAll: mutex := "";
    MonitorExit: mutex := "";
        
end while;
end process;
end algorithm *)
\* BEGIN TRANSLATION (chksum(pcal) = "de7794bf" /\ chksum(tla) = "46fe0a5e")
...
thread0 == thread0Enter \/ MonitorEnter0 \/ A \/ a2 \/ deque0
...
thread1 == thread1Enter \/ MonitorEnter1 \/ A1 \/ a12 \/ deque1
...
\* Last modified Sat Jan 09 17:07:23 MSK 2021 by ruslan
