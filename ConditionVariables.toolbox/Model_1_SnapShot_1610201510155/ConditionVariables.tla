...
\* BEGIN TRANSLATION (chksum(pcal) = "358d0b30" /\ chksum(tla) = "a92c07cf")
...
thread0 == thread0Enter \/ MonitorEnter0 \/ A \/ a0 \/ a2 \/ deque0
...
\* Last modified Sat Jan 09 17:11:33 MSK 2021 by ruslan
